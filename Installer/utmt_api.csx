...
string postfixes = "";
string sounds = "";
string listDir = Environment.GetEnvironmentVariable("NYON_LIST_DIR");
...
if (string.IsNullOrWhiteSpace(overrides) && string.IsNullOrWhiteSpace(prefixes) && string.IsNullOrWhiteSpace(postfixes) && string.IsNullOrWhiteSpace(sounds))
    throw new ScriptException("No patch file list provided (NYON_LIST_DIR).");
...
string gameDir = Environment.GetEnvironmentVariable("NYON_GAME_DIR");
